function app(){
  ...
  app.__moduleStartupDone = function(permProps){
    var oldBindings = activeModules['app'].bindings;
    activeModules['app'].bindings = function(){
    ...
    function installCode(code_0){
      ...
      if (app.__errFn) {
        script.onerror = function(){
          app.__errFn('app', new Error('Failed to load ' + code_0));
        }
        ;
      }
  ...
  function getCompiledCodeFilename(){
    ...
    var strongName;
    try {
      unflattenKeylistIntoAnswers(['gecko1_8'], '995EF99B9D4D38108CA18C4F03BB4A6B');
      unflattenKeylistIntoAnswers(['ie10'], '995EF99B9D4D38108CA18C4F03BB4A6B' + ':1');
      unflattenKeylistIntoAnswers(['ie8'], '995EF99B9D4D38108CA18C4F03BB4A6B' + ':2');
      unflattenKeylistIntoAnswers(['ie9'], '995EF99B9D4D38108CA18C4F03BB4A6B' + ':3');
      unflattenKeylistIntoAnswers(['safari'], '995EF99B9D4D38108CA18C4F03BB4A6B' + ':4');
  ...
  if ($wnd_0) {
    ...
    $wnd_0.__gwt_activeModules['app'].canRedirect = devModePermitted;
